...
object StartsWithLowercaseLetter: NamingRule {
    ...
    override fun warn(name: String): String = "$name should start with a lowercase letter! Consider changing it to ${apply(name)}"
}
...
object StartsWithUppercaseLetter: NamingRule {
    ...
    override fun warn(name: String): String = "$name should start with an uppercase letter! Consider changing it to ${apply(name)}"
}
...
object IsInCamelCase: NamingRule {
    ...
    override fun warn(name: String): String = "$name should be in camelcase! Consider changing it to ${apply(name)}"
}
...
object IsInUppercase: NamingRule {
    ...
    override fun warn(name: String): String = "$name should be in uppercase! Consider changing it to ${apply(name)}"
}
